...
const noPrint = ["ShiftRight","ShiftLeft", "Del", "CapsLock", "Shift", "Ctrl", "Win", "Alt", "Control"];
...
class KeyBoard {
  ...
  createDOMs(){
    ...
    symbolsEventCode.forEach((el) => {
      ...
      else if (el === "ShiftLeft" || el === "ShiftRight" || el === "Enter" || el == "Backspace" || el == "CapsLock") {
        key.classList.add("fun-key");
      }
  
      this.keyboard.append(key);
      if (el === "Backspace" || el === "Delete" || el === "Enter" || el === "ShiftRight") {
        this.keyboard.innerHTML += "<span style=\"clear: both; display: block; height: 4px; width: 100%\"></span>";
      }
